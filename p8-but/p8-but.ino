...
int buttXdown = 2, buttXup = 4, buttYdown = 6, buttYup = 7;
...
void loop() {
  ...
  if (activateBul) {
    ...
    if (check_butt(buttXdown) == 1) {
      while(check_butt(buttXdown) == 1){
        valueDiods += 3;
        delay(20);
      }
    }
    else if (check_butt(buttXup) == 1) {
      while(check_butt(buttXup) == 1){
        valueDiods += 5;
        delay(20);
      }
    }

    if (check_butt(buttYdown) == 1) {
      while(check_butt(buttYdown) == 1){
        valueDiods += 10;
        delay(20);
      }  
    }
    else if (check_butt(buttYup) == 1) {
      while(check_butt(buttYup) == 1){
        valueDiods += 1;
        delay(20);
      }  
    }
